...
Run_ecoroms_hindcast=function(get_date,outdir,namesrisk,weightings){ 
...
Run_ecoroms_hindcast(get_date = get_date,outdir = outdir,namesrisk = namesrisk,weightings = weightings)
